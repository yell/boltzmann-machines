...
# 10k
python rbm_mnist.py --load ../models/rbm_mnist_final/ --n-train 9000 --n-val 1000 --mlp-save-prefix '../data/rbm_10k_' --mlp-lrm 0.01 1.
python rbm_mnist.py --load ../models/rbm_mnist_final/ --n-train 9000 --n-val 1000 --mlp-no-init --mlp-save-prefix '../data/rbm_10k_no_init_' --mlp-lrm 1. 1.
